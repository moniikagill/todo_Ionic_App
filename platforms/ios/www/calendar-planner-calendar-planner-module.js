(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["calendar-planner-calendar-planner-module"],{
...
/***/ "./src/app/calendar-planner/calendar-planner.module.ts":
/*!*************************************************************!*\
  !*** ./src/app/calendar-planner/calendar-planner.module.ts ***!
  \*************************************************************/
/*! exports provided: CalendarPlannerPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CalendarPlannerPageModule", function() { return CalendarPlannerPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
...
/* harmony import */ var _calendar_planner_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./calendar-planner.page */ "./src/app/calendar-planner/calendar-planner.page.ts");
...
var routes = [
    {
        path: '',
        component: _calendar_planner_page__WEBPACK_IMPORTED_MODULE_7__["CalendarPlannerPage"]
    }
];
var CalendarPlannerPageModule = /** @class */ (function () {
    function CalendarPlannerPageModule() {
    }
    CalendarPlannerPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
            ...
            declarations: [_calendar_planner_page__WEBPACK_IMPORTED_MODULE_7__["CalendarPlannerPage"]]
        })
    ], CalendarPlannerPageModule);
    return CalendarPlannerPageModule;
}());
...
/***/ "./src/app/calendar-planner/calendar-planner.page.html":
/*!*************************************************************!*\
  !*** ./src/app/calendar-planner/calendar-planner.page.html ***!
  \*************************************************************/
...
/***/ "./src/app/calendar-planner/calendar-planner.page.scss":
/*!*************************************************************!*\
  !*** ./src/app/calendar-planner/calendar-planner.page.scss ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NhbGVuZGFyLXBsYW5uZXIvY2FsZW5kYXItcGxhbm5lci5wYWdlLnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/calendar-planner/calendar-planner.page.ts":
/*!***********************************************************!*\
  !*** ./src/app/calendar-planner/calendar-planner.page.ts ***!
  \***********************************************************/
/*! exports provided: CalendarPlannerPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CalendarPlannerPage", function() { return CalendarPlannerPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _crud_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../crud.service */ "./src/app/crud.service.ts");
...
var CalendarPlannerPage = /** @class */ (function () {
    function CalendarPlannerPage(alertCtrl, locale, toastCtrl, navCtrl, crudService, db) {
        ...
        this.calendartodoowner = firebase__WEBPACK_IMPORTED_MODULE_5__["auth"]().currentUser.uid;
        this.getCalendarData();
    }
    CalendarPlannerPage.prototype.getCalendarData = function () {
        var _this = this;
        // this.calendartodoowner = firebase.auth().currentUser.uid;
        this.db.collection('calendertodos').doc('mycalevents').collection(this.calendartodoowner).snapshotChanges().subscribe(function (colSnap) {
            _this.eventSource = [];
            colSnap.forEach(function (snap) {
                ...
                event.owner = _this.calendartodoowner;
                console.log(event);
                _this.eventSource.push(event);
            });
        });
    };
    CalendarPlannerPage.prototype.ngOnInit = function () {
        this.resetEvent();
    };
    CalendarPlannerPage.prototype.resetEvent = function () {
        this.event = {
            title: '',
            desc: '',
    ...
    CalendarPlannerPage.prototype.addEvent = function () {
        var eventCopy = {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_5__["firestore"]().collection('calendertodos').doc('mycalevents').collection(this.calendartodoowner).add(eventCopy); // or .set
        this.resetEvent();
    };
    CalendarPlannerPage.prototype.next = function () {
        // tslint:disable-next-line: no-string-literal
        var swiper = document.querySelector('.swiper-container')['swiper'];
        swiper.slideNext();
    };
    CalendarPlannerPage.prototype.back = function () {
        // tslint:disable-next-line: no-string-literal
        var swiper = document.querySelector('.swiper-container')['swiper'];
        swiper.slidePrev();
    };
    // Change between month/week/day
    CalendarPlannerPage.prototype.changeMode = function (mode) {
        this.calendar.mode = mode;
    };
    // Focus today
    CalendarPlannerPage.prototype.today = function () {
        this.calendar.currentDate = new Date();
    };
    // Selected date range and hence title changed
    CalendarPlannerPage.prototype.onViewTitleChanged = function (title) {
        this.viewTitle = title;
    };
    // Calendar event was clicked
    CalendarPlannerPage.prototype.onEventSelected = function (event) {
    ...
    CalendarPlannerPage.prototype.onTimeSelected = function (ev) {
        var selected = new Date(ev.selectedTime);
        this.event.startTime = selected.toISOString();
        selected.setHours(selected.getHours() + 1);
        this.event.endTime = (selected.toISOString());
    };
    CalendarPlannerPage.prototype.logout = function () {
        var _this = this;
    ...
    ], CalendarPlannerPage.prototype, "myCal", void 0);
    CalendarPlannerPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'app-calendar-planner',
            template: __webpack_require__(/*! ./calendar-planner.page.html */ "./src/app/calendar-planner/calendar-planner.page.html"),
            styles: [__webpack_require__(/*! ./calendar-planner.page.scss */ "./src/app/calendar-planner/calendar-planner.page.scss")]
        }),
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"], String, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"],
            _crud_service__WEBPACK_IMPORTED_MODULE_6__["CrudService"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_7__["AngularFirestore"]])
    ], CalendarPlannerPage);
...
//# sourceMappingURL=calendar-planner-calendar-planner-module.js.map